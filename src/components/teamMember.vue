                ...
                <div class=" mt-10 flex justify-end">
                  <div class="mt-10 flex relative w-full justify-end">
                    <form
                      ...
                      @submit.prevent="getNewMemberDetail"
                    >   
                      <label
                        for="voice-search"
                        class="sr-only"
                      ...
                      <div class="">
                        ...
                        <input
                          ...
                          v-model="userEmail"
                          type="email"
                          class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                      ...
                      <button
                        type="submit"
                        class="inline-flex items-center py-2.5 px-3 ml-2 text-sm font-medium text-white bg-primary-700 rounded-lg border border-primary-700 hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-600 dark:focus:ring-primary-800"
                      >
                  ...
                  <div class="flex items-center justify-between">
                    ...
                    <div>
                      <button
                        ...
                        @click="removeMembers(member.user.id)"
                      >
                        <TrashIcon
                          class="h-5 w-5 "
                          aria-hidden="true"
