            ...
            <DialogPanel class="relative transform overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
              <form>
                  ...
                  <div class="my-5">
                    ...
                    >
                      ...
                      >
                        ...
                        <option
                          v-for="item in nativeDitionaryNameList"
                          :key="item"
                          :value="item"
                        >
                          {{ item }}
                ...
                <div class="m-10">
                  ...
                  <select
                    id="org"
                    v-model="inputForm.organization_id"
                    name="org"
                    required
                    class="mt-2 block w-full rounded-md border-0 py-1.5 pl-3 pr-10 text-gray-900 ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-indigo-600 sm:text-sm sm:leading-6"
                  >
                ...
                <div
                  v-if="access_mode == 'Custom'"
                  class="m-10 sm:mt-6 sm:grid sm:grid-flow-row-dense sm:grid-cols-2 sm:gap-12"
                >
                  <button
                    type="submit"
                    ...
                    @click.prevent="handleCustomSubmit()"
                  >
                    <svg
                      v-if="customQueryLoading"
                      aria-hidden="true"
                ...
                >
                  <button
                    type="submit"
                    class="inline-flex w-full justify-center rounded-md bg-secondary-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-secondary-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-700 sm:col-start-2"
                    @click.prevent="handleNativeSubmit()"
                  >
                    <svg
                      v-if="nativeQueryLoading"
                      aria-hidden="true"
                      class="w-4 h-4 mr-2 text-white animate-spin dark:text-gray-600 fill-primary-500"
                      viewBox="0 0 100 101"
                      fill="none"
